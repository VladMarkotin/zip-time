            ...
            <div class="box-title border-bottom ">
                <h6 class="fw-bold p-2 heading-line-drop ">Notifications
                    ...
                    <div class="form-check float-end mr-3">
                        <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault" wire:model="unread"
                            value="all">
                        ...
                        <form wire:submit.prevent="saveNotification">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control" placeholder="Notification`s text" wire:model="data"></textarea>
                                    @error('data')
                                        <span class="error text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
