        ...
        <section class="slider-section">
            <div class="slider-wrapper">
                <div class="slide slide-one">
                    <div class="slide-content">
                        <div class="slide-content_inner-block">
                            <span class="slide-content-3d-title">Hi there! Quipl has 4 questions<br class="br"> for
                                you:</span>
                            <ul class="slide-one-list">
                                <li class="slide-one-li">
                                    <h3 class="slide-content-subtitle slide-one-title">Think you`re great but haven`t reached
                                        your potential yet?</h3>
                                </li>
                                <li class="slide-one-li">
                                    <h3 class="slide-content-subtitle slide-one-title">Wasting time instead self-developing?
                                    </h3>
                                </li>
                                <li class="slide-one-li">
                                    <h3 class="slide-content-subtitle slide-one-title">Sometimes don`t have enough
                                        self-discipline?</h3>
                                </li>
                                <li class="slide-one-li">
                                    <h3 class="slide-content-subtitle slide-one-title">Can`t find out how efficient you are?
                                    </h3>
                                </li>
                            </ul>
                    ...
                    <div class="slide-content">
                        <div class="slide-content_inner-block">
                            <div class="slide-content-text-wrapper">
                                <h2 class="slide-content-title"><span class="red-text">Quipl</span> is a day planing system
                                    which gonna solve all mentioned problems</h2>
                                <div class="slide-two-content">
                                    ...
                                    <ul class="slide-two-list">
                                        <li class="slide-two-li">
                                            ...
                                            <p class="slide-content-text">Create day plan with plenty of<br class="br">
                                                required jobs</p>
                                        </li>
                                        <li class="slide-two-li">
                                        ...
                                        <li class="slide-two-li">
                                            ...
                                            <p class="slide-content-text">Evaluate yourself for every job. No deadline while day
                                                is not closed.</p>
                                        </li>
                                        <li class="slide-two-li">
                                            <span class="slide-two-li-number slide-content-text">4 . </span>
                                            <p class="slide-content-text">After all required jobs done,<br class="br"> close
                                                day plan and get your day efficiency</p>
                                        </li>
                                        <li class="slide-two-li">
                                            <span class="slide-two-li-number slide-content-text">5 . </span>
                                            <p class="slide-content-text"><span class="red-text">Congratulations!</span> Just
                                                see your history, statistic and realize you are awesome!</p>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="slide-three-content">
                                <ul class="slide-three-list">
                                    <li class="slide-three-li">
                                        ...
                                        <p class="slide-content-text">It`s hard to me to set a clearly defined task or to divide
                                            it<br class="br"> on subtasks <span><svg xmlns="http://www.w3.org/2000/svg"
                                                    class="smile-icon smile-icon-sad" viewBox="0 0 24 24">
                                                    <path
                                    ...
                                    <li class="slide-three-li">
                                        ...
                                        <p class="slide-content-text">I doubt to start something new and complex cause I simply
                                            don`t know how to start <span><svg xmlns="http://www.w3.org/2000/svg"
                                                    class="smile-icon smile-icon-sad" viewBox="0 0 24 24">
                                                    <path
                                                        d="M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M7,9.5C7,8.7 7.7,8 8.5,8C9.3,8 10,8.7 10,9.5C10,10.3 9.3,11 8.5,11C7.7,11 7,10.3 7,9.5M14.77,17.23C14.32,16.5 13.25,16 12,16C10.75,16 9.68,16.5 9.23,17.23L7.81,15.81C8.71,14.72 10.25,14 12,14C13.75,14 15.29,14.72 16.19,15.81L14.77,17.23M15.5,11C14.7,11 14,10.3 14,9.5C14,8.7 14.7,8 15.5,8C16.3,8 17,8.7 17,9.5C17,10.3 16.3,11 15.5,11Z" />
                                                </svg></span></p>
                                ...
                                <div class="slide-content-text-wrapper">
                                    ...
                                    <h3 class="slide-content-subtitle subtitle-third-slide"><span class="red-text">Quipl</span>
                                        & <span class="red-text">ChatGPT</span><br class="br"> always ready to help
                                        <span><svg xmlns="http://www.w3.org/2000/svg" class="smile-icon smile-icon-cool"
                                                viewBox="0 0 24 24">
                                                <path
                                    ...
                                    <h3 class="slide-content-subtitle subtitle-third-slide">Key things you need are focus and
                                        constancy.<span class="just-try-it-wrapper"><a href="{{ route('register') }}"> Just try
                                                it!</a></span></h3>
                                </div>
                            </div>
                ...
                <div class="slider-left-arrow-wrapper slider-arrow transparent">
                    <svg class="slider-left-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    ...
                    <div class="about-us-text-wrapper">
                        ...
                        <ul class="about-us-list">
                            <li class="about-us-li about-us-item element-animation">
                                ...
                                <p class="text-index-page">Begin planning! Every day no less then 2 required tasks. The crucial
                                    word is “required”. If at least one task was`t completed, the plan failed</p>
                            </li>
                            <li class="about-us-li about-us-item element-animation">
                                <span class="about-us-li-number text-index-page">2.</span>
                                <p class="text-index-page">Do it! You got all day. You may complete all tasks in any order
                                    until day isn`t over (23:59)</p>
                            </li>
                            <li class="about-us-li about-us-item element-animation">
                                <span class="about-us-li-number text-index-page">3.</span>
                                <p class="text-index-page">After task is done - rate yourself. Put mark from 15% to 100%. The
                                    only and most honest judge is you!</p>
                            </li>
                            <li class="about-us-li about-us-item element-animation">
                                <span class="about-us-li-number text-index-page">4.</span>
                                <p class="text-index-page">After all tasks have been done - close day plan. If you forget to do
                                    this before the end of the day, Quipl will do it itself!</p>
                            </li>
                            <li class="about-us-li about-us-item element-animation">
                                <span class="about-us-li-number text-index-page">5.</span>
                                <p class="text-index-page"><span class="red-text">Congratulations!</span> Just see your
                                    history, statistic and realize you are awesome!</p>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="our-advantages-content">
                        <div class="our-advantages-item element-animation">
                            ...
                            <div class="our-advantages-text">
                                <p class="text-index-page ">Now you will always know your efficiency. Moreover, you will be
                                    able to observe the dynamics of your success. No more rhetorical questions about whether you
                                    are doing enough</p>
                            </div>
                        </div>
                        <div class="our-advantages-item element-animation">
                        ...
                        <div class="our-advantages-item element-animation">
                            ...
                            <div class="our-advantages-text">
                                <p class="text-index-page ">Every success and every mistake has its own story. Quipl will help
                                    you remember successes and draw conclusions from mistakes</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="statistics-content">
                    <div class="statistics-item element-animation">
                        <div class="statistics-icon-wrapper">
                            <svg class="statistics-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                <path
                    ...
                    <div class="statistics-item element-animation">
                        ...
                        <div class="statistics-counter-wrapper">
                            <h2 data-counterVal={{ $statData['completed_tasks'] }} class="statistics-counter title-index-page">
                                0</h2>
                        </div>
                        <div class="statistics-text-wrapper">
                    ...
                    <div class="statistics-item element-animation">
                        ...
                        <div class="statistics-counter-wrapper">
                            <h2 data-counterVal={{ $statData['completed_days'] }} class="statistics-counter title-index-page">0
                            </h2>
                        </div>
                        <div class="statistics-text-wrapper">
                            ...
                            <div class="philosofy-slider-line">
                                <div class="philosofy-slide philosofy-slide-one">
                                    <div class="philosofy-slide-text-wrapper">
                                        <p class="philosofy-slide-text text-index-page">Quipl has borrowed crutial ideas from
                                            “Getting Things Done” (GTD) method but we complemented it with some intresting
                                            points:</p>
                                    </div>
                                    <div class="philosofy-list-wrapper">
                                        <ul class="philosofy-list">
                                            <li class="philosofy-li philosofy-item element-animation">
                                                <span class="philosofy-li-number philosofy-slide-text text-index-page">1
                                                    .</span>
                                                <p class="philosofy-slide-text text-index-page">The daily plan should consist
                                                    of at least 2 required jobs.</p>
                                            </li>
                                            <li class="philosofy-li philosofy-item element-animation">
                                                <span class="philosofy-li-number philosofy-slide-text text-index-page">2
                                                    .</span>
                                                <p class="philosofy-slide-text text-index-page">You can't canceled or “fail”
                                                    none of them.</p>
                                            </li>
                                            <li class="philosofy-li philosofy-item element-animation">
                                                <span class="philosofy-li-number philosofy-slide-text text-index-page">3
                                                    .</span>
                                                <p class="philosofy-slide-text text-index-page">To “fail” means do not have
                                                    time to grade the assignment before the end of the day (23:59)</p>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="philosofy-list-wrapper">
                                        <ul class="philosofy-list">
                                            <li class="philosofy-li">
                                                <span class="philosofy-li-number philosofy-slide-text text-index-page">4
                                                    .</span>
                                                <p class="philosofy-slide-text text-index-page">You evaluate yourself :) You
                                                    are the only one who can do this accurately. Evaluate yourself for each job.
                                                </p>
                                            </li>
                                            <li class="philosofy-li">
                                                <span class="philosofy-li-number philosofy-slide-text text-index-page">5
                                                    .</span>
                                                <p class="philosofy-slide-text text-index-page">In the end of the day (23:59)
                                                    Quipl will automatically closed your day plan </p>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="quotes-list-wrapper">
                            <ul class="quotes-list">
                                <li class="quotes-li quotes-item element-animation">
                                    <div class="quotes-text text-index-page">“The most precious resource we all have is time”
                                    </div>
                                    <div class="quotes-author">― Steve Jobs</div>
                                </li>
                                <li class="quotes-li quotes-item element-animation">
                                    <div class="quotes-text text-index-page">“We must use time creatively - and forever realize
                                        that the time is always hope to do great things.”</div>
                                    <div class="quotes-author">― Martin Luther King Jr</div>
                                </li>
                                <li class="quotes-li quotes-item element-animation">
                                    <div class="quotes-text text-index-page">“The wisest are the most annoyed at the loss of
                                        time”</div>
