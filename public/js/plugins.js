...
/*!****************************************!*\
  !*** ./resources/js/design/plugins.js ***!
  \****************************************/
  ...
  var e = {
    ...
    o = function o() {
      for (var e = i.scrollTop(), o = n.height(), a = o - r, c = e > a ? a - e : 0, p = 0; p < s.length; p++) {
        var l = s[p],
          ...
          h = d - l.topSpacing - c;
        if (h >= e) null !== l.currentTop && (l.stickyElement.css("position", "").css("top", ""), l.stickyElement.trigger("sticky-end", [l]).parent().removeClass(l.className), l.currentTop = null);else {
    ...
    c = {
      ...
      unstick: function unstick() {
        return this.each(function () {
          for (var e = t(this), i = -1, n = 0; n < s.length; n++) s[n].stickyElement.get(0) == e.get(0) && (i = n);
          -1 != i && (s.splice(i, 1), e.unwrap(), e.removeAttr("style"));
        });
      }
    };
