<template>
    <div>
        ...
        <v-data-iterator :items="['temp']" hide-default-footer>
        ...
        <div class="d-flex justify-space-between mt-3">
            <v-tooltip right>
                <template v-slot:activator="{on,attrs}">
                    <v-btn color="#D71700" style="text-color : #ffffff" icon v-bind="attrs" v-on:click="dialog = true" v-on="on">
            ...
            <v-dialog v-model="dialog" persistent max-width="650px">
                <v-card>
                    ...
                    <v-card-actions class="justify-space-between">
                        <v-btn @click="dialog = false">Emergency call</v-btn>
            ...
            <v-tooltip right>
                <template v-slot:activator="{on,attrs}">
                    <v-btn color="#D71700" style="text-color : #ffffff" icon v-on:click="" v-bind="attrs" v-on="on">
...
<script>
    ...
    import {mdiSendClock,mdiCarEmergency} from '@mdi/js'
    export default
    {
        ...
        data()
        {
            return {icons : {mdiSendClock,mdiCarEmergency},dialog : false,dates : ['2019-09-10', '2019-09-20'],comment : ''}
        },
        computed :
        {
            dateRangeText()
        ...
        validations :
        {
            // ? : {minLength : minLength(50),maxLength : maxLength(99)},
        }
    }
</script>